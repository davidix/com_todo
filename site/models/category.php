...
/**
 * Item Model for category.
 *
 * @package     Todo
 * @subpackage  Models
 */
class TodoModelCategory extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_TODO';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_todo.category';
	 ...
	 */
	public function getTable($type = 'Category', $prefix = 'TodoTable', $config = array())
	{
